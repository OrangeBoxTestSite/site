            ...
            (e = {
                ...
                showProducts: function (s) {
                    let r = t("<form>").attr({ class: "smart-basket__form", method: "POST", id: "smart-basket__form", enctype: "multipart/form-data" }),
                        ...
                        l = t("<div>").attr({ class: "smart-basket__product-quantity smart-basket__product-quantity_header" }).text("Коливо"),
                ...
                commonResult: function (e, s, r) {
                    let n = 0,
                        ...
                        l = t("<div>").attr({ class: "smart-basket__success-title" }).text("Заказ принят. Ожидайте.").css("display", "none"),
